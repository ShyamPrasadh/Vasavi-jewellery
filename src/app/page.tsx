      ...
      <div className="max-w-5xl mx-auto px-4 mt-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-10">
          ...
          <div className="col-span-2 md:col-span-1 bg-white p-5 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group">
            ...
            <label className="block text-[11px] font-black text-gray-600 uppercase tracking-widest mb-3">Product Name</label>
          ...
          <div className="col-span-1 md:col-span-1 bg-white p-5 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-1 h-full bg-[#D4AF37]"></div>
            <label className="block text-[11px] font-black text-gray-600 uppercase tracking-widest mb-3">Weight (Grams)</label>
          ...
          <div className="col-span-1 md:col-span-1 bg-white p-5 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden group">
            ...
            <div className="flex justify-between items-center mb-3">
              <label className="block text-[11px] font-black text-gray-600 uppercase tracking-widest">Gold Rate (22KT)</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden flex flex-col h-full">
            <div className="bg-[#333333] text-white px-4 py-3 flex items-center gap-3">
              <CalcIcon size={20} />
              <h2 className="text-base font-black uppercase tracking-widest">Detailed Breakup</h2>
            </div>
            <div className="p-4 flex-1 flex flex-col justify-center space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-gray-600 uppercase tracking-widest">Gold Value</span>
              ...
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-gray-600 uppercase tracking-widest">Wastage Cost</span>
              ...
              <div className="flex justify-between items-center pb-3 border-b-2 border-dashed border-gray-100">
                <span className="text-xs font-bold text-gray-600 uppercase tracking-widest">Labour Charge</span>
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-amber-100/50 border border-gray-100 overflow-hidden flex flex-col h-full">
            <div className="bg-gradient-to-r from-[#D4AF37] to-[#B8860B] text-white px-4 py-3 flex items-center gap-3">
              <Percent size={20} />
              <h2 className="text-base font-black uppercase tracking-widest">Value Addition (VA)</h2>
            </div>
            <div className="p-4 flex-1 grid grid-cols-2 gap-0 items-center">
              ...
              <div className="space-y-4 pr-4 border-r-2 border-dashed border-gray-100">
                <div className="text-center">
                  <p className="text-[11px] text-gray-600 font-black uppercase tracking-widest mb-1">Waste (mg)</p>
                ...
                <div className="text-center">
                  <p className="text-[11px] text-gray-600 font-black uppercase tracking-widest mb-1">Labour Charge</p>
              ...
              <div className="pl-4 flex flex-col justify-center space-y-4">
                <div className="text-center">
                  <p className="text-gray-600 uppercase text-[11px] font-black tracking-widest mb-1">Overall VA %</p>
                  <p className="text-2xl md:text-3xl font-black text-[#D4AF37] tracking-tighter">{calculations.vaPercent.toFixed(2)}%</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-600 uppercase text-[11px] font-black tracking-widest mb-1">Total VA Amount</p>
