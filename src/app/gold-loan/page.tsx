...
import {
    ...
    Filter, Calendar, ArrowUpDown, IndianRupee, AlertCircle, Clock, CheckCircle, Circle, LayoutGrid, List
} from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 mt-6 md:mt-8">
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        {/* View Mode Toggle */}
                        <div className="bg-white border border-gray-200 rounded-xl p-1 flex items-center gap-1 shadow-sm h-[40px]">
                            <button
                                onClick={() => setViewMode('card')}
                                className={`p-2 rounded-lg transition-all ${viewMode === 'card' ? 'bg-[#D4AF37]/10 text-[#B8860B]' : 'text-gray-400 hover:bg-gray-50'}`}
                                title="Card View"
                            >
                                <LayoutGrid size={16} />
                            </button>
                            <button
                                ...
                                className={`p-2 rounded-lg transition-all ${viewMode === 'list' ? 'bg-[#D4AF37]/10 text-[#B8860B]' : 'text-gray-400 hover:bg-gray-50'}`}
                                title="List View"
                            >
                                <List size={16} />
                            </button>
                                ...
                                filteredLoans.map((loan) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all cursor-pointer group flex flex-col"
                                        >
                                            {/* Header Section */}
                                            <div className={`px-4 py-2 flex items-center justify-between ${loan.status === 'settled' ? 'bg-gray-100/50' :
                                                isOverdue ? 'bg-red-50' : 'bg-[#E8F5E9]'
                                                }`}>
                                                ...
                                                <div className="flex justify-between items-start mb-4">
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                                                            ...
                                                            {loan.productType}
                                                            {loan.productWeight && <span className="text-gray-300">•</span>}
                                                            {loan.productWeight && `${loan.productWeight}g`}
                                                        </div>
                                                    </div>
                                            ...
                                            filteredLoans.map((loan) => {
                                                ...
                                                return (
                                                    <tr
                                                        key={loan.id}
                                                        onClick={() => openDetails(loan)}
                                                        className={`group hover:bg-gray-50 transition-colors cursor-pointer ${loan.status === 'settled' ? 'opacity-75 bg-gray-50/50' : ''}`}
                                                    >
                                                        <td className="px-6 py-4 text-xs font-bold text-gray-500 font-mono">
                                                            {loan.billNumber}
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <p className="text-sm font-black text-gray-800 uppercase">{loan.customerName}</p>
                                                            <p className="text-[10px] font-bold text-gray-400">{loan.customerPhone}</p>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <div className="flex flex-col">
                                                                <span className="text-xs font-bold text-gray-700 uppercase">{loan.productType}</span>
                                                                <span className="text-[10px] font-bold text-gray-400">{loan.productWeight}g</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="px-6 py-4 text-right">
                                                            <span className="text-sm font-black text-gray-800">₹{summary.totalPrincipal.toLocaleString('en-IN')}</span>
                                                        </td>
                                                        <td className="px-6 py-4 text-right">
                ...
                {/* View Details Modal - Full Screen Practical View */}
                {
                    showDetailsModal && viewingLoan && (() => {
                        const loan = viewingLoan; // Create local ref for type narrowing
