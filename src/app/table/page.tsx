    ...
    return (
        <main className={`fixed inset-0 bg-white flex flex-col overflow-hidden overscroll-none transition-all duration-300 ${isCollapsed ? 'md:left-[64px]' : 'md:left-[280px]'}`}>
            ...
            <div className="flex-1 flex flex-col pt-[54px] md:pt-[60px] min-h-0 overflow-hidden overscroll-none">
                ...
                {/*
                  One card scroller for table + policy so reaching the end of the table
                  continues into the policy note (no nested overscroll trap).
                  Dual-axis overflow keeps sticky thead + sticky weight column.
                  Equal side gaps come from this padded column (not a width calc on the card).
                  Scrollbar clip expands width/height so native bars sit outside the rounded clip.
                */}
                <div className="flex-1 min-h-0 overflow-hidden overscroll-none px-4 md:px-5 py-4 md:py-5">
                    <div className="h-full w-full rounded-2xl md:rounded-3xl border border-gray-100 shadow-xl bg-white overflow-hidden overscroll-none">
                        <div
                        ...
                        >
                            ...
                            {/* Policy — same scroller as the table; sticky-left so it stays card-width while table scrolls horizontally */}
                            <div className="sticky left-0 z-10 w-full p-4 md:p-5 bg-white">
